...
const copy = {
  ru: {
    ...
    accountEdit: 'Изменить',
    accountSaveSuccess: 'Профиль сохранён',
    accountSaveError: 'Не удалось сохранить профиль',
    accountAvatarChange: 'Сменить фото',
    accountAvatarUploading: 'Загрузка…',
    accountAvatarSuccess: 'Фото обновлено',
    accountAvatarError: 'Не удалось загрузить фото',
    accountAvatarRemove: 'Удалить фото',
    accountAvatarRemoveSuccess: 'Фото удалено',
    accountAvatarHint: 'JPEG, PNG, WebP или GIF · до 2 МБ',
    accountCareerTracks: 'Направления',
    accountCareerTracksHint:
      'Каждый чат с разной ролью сохраняется в своё направление. Выберите, какое показывать.',
    accountCareerSelectError: 'Не удалось переключить направление',
    ...
    skipSpeech: 'Пропустить озвучку',
    skipSpeechDone: 'Озвучка пропущена',
  ...
  en: {
    ...
    accountEdit: 'Edit',
    accountSaveSuccess: 'Profile saved',
    accountSaveError: 'Failed to save profile',
    accountAvatarChange: 'Change photo',
    accountAvatarUploading: 'Uploading…',
    accountAvatarSuccess: 'Photo updated',
    accountAvatarError: 'Failed to upload photo',
    accountAvatarRemove: 'Remove photo',
    accountAvatarRemoveSuccess: 'Photo removed',
    accountAvatarHint: 'JPEG, PNG, WebP or GIF · up to 2 MB',
    accountCareerTracks: 'Directions',
    accountCareerTracksHint:
      'Each chat with a different role is saved as its own direction. Pick which one to show.',
    accountCareerSelectError: 'Failed to switch direction',
    ...
    muteOn: 'Unmute',
    muteOff: 'Mute',
    skipSpeech: 'Skip voice',
    skipSpeechDone: 'Voice skipped',
