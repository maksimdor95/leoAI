...
export function HeroSection() {
  ...
  return (
    <section className="leo-hero-shell relative min-h-screen overflow-x-hidden">
      <div className="landing-hero-bg-hume pointer-events-none absolute inset-x-0 top-0 z-0 h-[11rem] overflow-hidden bg-[var(--color-bone)] opacity-95 sm:h-[13rem] lg:h-[14rem]">
