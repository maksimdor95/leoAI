...
export const WANNANEW_SCENARIO: ScenarioDefinition = {
  ...
  steps: [
    ...
    // ============================================
    {
      ...
      instruction:
        'Поздоровайся с кандидатом. Представься как LEO и объясни, что поможешь подготовиться к собеседованиям на позицию Product Manager: проанализируешь опыт и проведёшь голосовое пробное интервью. Уточни, готов ли начать.',
      fallbackText:
        'Привет! Я LEO — AI-агент для подготовки к собеседованиям на Product Manager. За 10-15 минут проанализирую твой опыт и проведу голосовое пробное интервью. Готов начать?',
