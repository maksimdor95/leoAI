...
export const WANNANEW_SCENARIO: ScenarioDefinition = {
  ...
  steps: [
    ...
    // ============================================
    {
      ...
      instruction:
        'Попроси кандидата загрузить резюме (PDF/DOCX) или кратко описать свой опыт в продукте. В MVP принимаем текстовый ввод.',
      fallbackText:
    ...
    // ============================================
    {
      ...
      cards: [
        {
          title: '📊 Оценка',
          content: 'Анализ твоих ответов и оценка уровня как PM.',
          icon: '📊',
        },
        {
          title: '📝 Рекомендации',
          content: 'Персональные советы по улучшению и подготовке к интервью.',
          icon: '📝',
        },
        {
          title: '❓ Вопросы',
          content: 'Список типовых интервью-вопросов под твой уровень.',
          icon: '❓',
        },
        {
          title: '📄 PDF-отчёт',
          content: 'Нажми кнопку ниже, чтобы скачать полный отчёт.',
          icon: '📄',
        },
      ],
      commands: [
