...
export const JACK_SCENARIO: ScenarioDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      description:
        'Я зафиксировал главное и уже подбираю вакансии. Откройте вкладку «Вакансии», чтобы увидеть первые совпадения. Можно уточнить детали или перейти к детальному анализу — просто напишите.',
      cards: [
        {
          icon: '🎯',
          title: 'Подбор вакансий',
          content: 'Сопоставляю профиль с каталогом и обновляю shortlist по релевантности.',
        },
        {
          icon: '💬',
          title: 'Что дальше',
          content:
            'Задайте уточнения, попросите детальный разбор профиля или сформировать резюме — я помогу.',
        },
      ],
      next: null,
    },
